...
$id = mysqli_real_escape_string($connection, $_REQUEST['id']);
   ...
   $sql = "DELETE FROM process_product_customer WHERE id_process_product_customer = $id";
   $success = false;
   ...
   if($success){
		header("Location: http://imagine-studio-solutions.com/production/app/msg/deleted-process.php");
   }else{
		header("Location: http://imagine-studio-solutions.com/production/app/msg/deleted-process-error.php");
   }
