        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Listado Usuarios</h3>
                            <p class="text-muted m-b-30">Usuarios activos e inactivos.</p>
                                ...
                                <table id="myTable" class="table table-striped">
									...
									<?php 
                                                    while($row = mysqli_fetch_assoc($result_QueryGetUsers)){
															...
															echo '<td>'. '●●●●●●●●' . '</td>'; // $row["password"] not correctly to show up. 
															echo '<td>'. $row["users_type_name"] . '</td>';
															echo '<td>'. $row["created_by"].'</td>';
                                                            echo '<td>'. $row["date_added"] . '</td>';
                                                            echo '<td>';?>
															<button type="button" title="Editar" onClick="confirmEdit('update-user.php?id=<?php echo $row["id_user"];?>')" class="btn btn-info btn-outline btn-circle btn-lg m-r-5" ><i class="ti-pencil-alt"></i></button>
                                                            <button type="button" title="Eliminar" onClick="confirmDelete('delete_user.php?id=<?php echo $row["id_user"];?>')" class="btn btn-info btn-outline btn-circle btn-lg m-r-5"><i class="icon-trash"></i></button>
															<?php
															echo '</td>';
                                                            echo '</tr>';
                                                    } 
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Crear Usuarios</h3>
                            <p class="text-muted m-b-30"> Verifique que la informacion sea la correcta.</p>
                            <form data-toggle="validator" action="insert_user.go" method="POST">
                                <div class="form-group">
									<div class="row">
										<div class="form-group col-sm-6">
										<label for="first_name" class="control-label">Nombres</label>
											<input type="text" class="form-control" id="first_name" name="first_name" placeholder="Ejemplo: Jose" required><div class="help-block with-errors"></div>
										</div>									
										<div class="form-group col-sm-6">
										<label for="first_name" class="control-label">Apellidos</label>
											<input type="text" class="form-control" id="last_name" name="last_name" placeholder="Ejemplo: Perez" required><div class="help-block with-errors"></div>
										</div>
                                    </div>
                                </div>
                                <div class="form-group">
									<div class="row">
										...
										<label for="user_email" class="control-label">Email</label>
											<input type="email" class="form-control" id="user_email" name="user_email" placeholder="Email" data-error="El correo proporciondo no tiene un formato valido" required><div class="help-block with-errors"></div>
										</div>
										<div class="form-group col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            <input type="password" data-toggle="validator" data-minlength="6" class="form-control" id="upassword" name="upassword" placeholder="Clave" required> <span class="help-block">Ingrese 6 caracteres como minimo</span> </div>
                                        <div class="form-group col-sm-6">
                                            <input type="password" class="form-control" id="inputPasswordConfirm" name="inputPasswordConfirm" data-match="#upassword" data-match-error="Las claves no coinciden" placeholder="Confirme la clave" required>
