...
$id=mysqli_real_escape_string($connection, $_REQUEST['id_customer']);
...
$sql = "UPDATE customers SET customer_name='$customer_name', customer_address='$customer_address', customer_number='$customer_number', f_country=$f_country, notes='$notes' WHERE id_customer=$id;";
