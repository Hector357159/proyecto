...
$QueryGetCustomers = "select c.id_customer,c.customer_name, c.customer_address,c.customer_number,c.date_added,co.nicename as country from customers as c,country as co where co.id_country = c.f_country;"; 
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">MANTENIMIENTO DE CLIENTES</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Listado Clientes</h3>
                            <p class="text-muted m-b-30">Clientes Activos</p>
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped">
									...
									<?php 
                                                    while($row = mysqli_fetch_assoc($result_QueryGetCustomers)){
                                                            ...
                                                            echo '<td>';?>
															<button type="button" title="Editar" onClick="confirmEdit('update-customer.php?id=<?php echo $row["id_customer"];?>')" class="btn btn-info btn-outline btn-circle btn-lg m-r-5" ><i class="ti-pencil-alt"></i></button>
                                                            <button type="button" title="Eliminar" onClick="confirmDelete('delete_customer.php?id=<?php echo $row["id_customer"];?>')" class="btn btn-info btn-outline btn-circle btn-lg m-r-5"><i class="icon-trash"></i></button>
															<?php
															echo '</td>';
                                                            echo '</tr>';
                                                    } 
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Crear Clientes</h3>
                            <p class="text-muted m-b-30"> Verifique que la informacion sea la correcta.</p>
                            <form data-toggle="validator" action="insert_customer.go" method="POST">
                                <div class="form-group">
									<div class="row">
										<div class="form-group col-sm-6">
										<label for="customer_name" class="control-label">Nombre</label>
											<input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Ejemplo: Cliente_X" required><div class="help-block with-errors"></div>
										</div>									
										<div class="form-group col-sm-6">
										<label for="customer_name" class="control-label">Direccion</label>
											<input type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Ejemplo: Calle X, # Y" required><div class="help-block with-errors"></div>
										</div>
                                    </div>
                                </div>
                                <div class="form-group">
									<div class="row">
										...
										<label for="customer_number" class="control-label">Numero de Contacto</label>
											<input type="text" class="form-control" id="customer_number" name="customer_number" placeholder="Numero" required><div class="help-block with-errors"></div>
										</div>
										<div class="form-group col-sm-6">
										<label for="user_email" class="control-label">Pais</label>
											...
											<?php
												...
												while($res1 = mysqli_fetch_assoc($result_countries)){
													if($default_country==$res1["country_name"]){
