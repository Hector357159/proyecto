...
$id = mysqli_real_escape_string($connection, $_REQUEST['id']);
   ...
   if($success){
		header("Location: http://imagine-studio-solutions.com/production/app/msg/deleted-customer.php");
   }else{
		header("Location: http://imagine-studio-solutions.com/production/app/msg/deleted-customer-error.php");
   }
