...
$sql = "INSERT INTO users (user_name, user_last_name, user_email, f_User_type, notes, user_password,user_gender,f_createdby) VALUES ('$user_name', '$user_last_name', '$user_email',$f_User_type,'$notes','$user_password','$user_gender',$f_created_by);";
...
if($success){
		header("Location: http://imagine-studio-solutions.com/production/app/msg/usr-inserted.php");
   }else{
		header("Location: http://imagine-studio-solutions.com/production/app/msg/usr-error.php");
   }
?>