 ...
 <!-- /Logo -->
                ...
                <ul class="nav navbar-top-links navbar-left">
                    ...
                    <!-- .Megamenu -->
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><span class="hidden-xs">Reporteria</span> <i class="icon-options-vertical"></i></a>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            <li>
                                <div class="dw-user-box">
                                    ...
                                    <div class="u-text">
                                        ...
                                        <p class="text-muted"><?php echo $res1['user_email'];?></p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">Perfil</a></div>
                                </div>
                            </li>
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="#"><i class="ti-settings"></i> Configuracion General</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo HTTP_SERVER . 'logout.php'; ?>"><i class="fa fa-power-off"></i> Cerrar Sesion</a></li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
