...
session_start();
	...
	$QUERYempresa = "SELECT CONCAT(user_name, ' ', user_last_name) as name FROM users WHERE user_email="."'".$_SESSION["Us3rN4mE"]."'".";";
...
and P.production_date>=CURDATE() and P.production_date <CURDATE()+1;";
	...
	$result1 = mysqli_query($connection, $QUERYempresa) or trigger_error("Query Failed! SQL: $query - Error: ". mysqli_error($connection), E_USER_ERROR);
	$result2 = mysqli_query($connection, $QueryTodayEarnings) or trigger_error("Query Failed! SQL: $query - Error: ". mysqli_error($connection), E_USER_ERROR);
...
<head>
    ...
    <title>Produses Production Control</title>
    <!-- Bootstrap Core CSS -->
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="../plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php echo $res1['name'];?></b><span class="caret"></span> </a>
                             ...
                             <div class="row row-in">
                                  ...
                                  <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                    <ul class="col-in">
                                            ...
                                            <li class="col-last"><h3 class="counter text-right m-t-15"><?php echo $res2["earnings"];?></h3></li>
                                            <li class="col-middle">
