...
$id = mysqli_real_escape_string($connection, $_REQUEST['id']);
   ...
   if($success){
		header("Location: http://imagine-studio-solutions.com/production/app/msg/deleted.php");
   }else{
		header("Location: http://imagine-studio-solutions.com/production/app/msg/deleted-error.php");
   }
