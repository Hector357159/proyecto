                                    ...
                                    <table style="clear: both" class="table table-bordered table-striped" id="user">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" id="inline-sex" data-type="select" data-pk="1" data-value="1" data-title="Select sex"></a>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table style="clear: both" class="table table-bordered table-striped" id="user">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Try</td>
                                                <td>
                                                    <a href="#" id="sex" data-type="select" data-pk="1" data-value="1" data-title="Select sex"></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Select, error while loading</td>
