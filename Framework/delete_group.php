...
$id = mysqli_real_escape_string($connection, $_REQUEST['id']);
   ...
   $sql = "DELETE FROM daily_workgroup WHERE id_daily_workgroup = $id";
   $success = false;
   ...
   if($success){
		header("Location: http://imagine-studio-solutions.com/production/app/msg/deleted-group.php");
   }else{
		//header("Location: http://imagine-studio-solutions.com/production/app/msg/deleted-group-error.php");
   }
