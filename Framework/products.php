...
session_start();
	...
	if($_SESSION["Us3r_Typ3"]=='Operario'){
...
$QueryGetProducts = "Select p.id_product,p.product_code,p.name_product,p.date_created,c.customer_name FROM product as p, customers as c where c.id_customer = p.f_customer;";
...
$QUERYGetActiveUser = "SELECT CONCAT(user_name, ' ', user_last_name) as name FROM users WHERE user_email="."'".$_SESSION["Us3rN4mE"]."'".";";
	...
	$result_products = mysqli_query($connection, $QueryGetProducts) or trigger_error("Query Failed! SQL: $QueryGetProducts - Error: ". mysqli_error($connection), E_USER_ERROR);
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Listado Productos</h3>
                            <p class="text-muted m-b-30">Productos Activos</p>
                                ...
                                <table id="myTable" class="table table-striped">
									...
									<?php 
                                                    while($row = mysqli_fetch_assoc($result_products)){
                                                            ...
                                                            echo '<td>';?>
															<button type="button" title="Editar" onClick="confirmEdit('update-product.php?id=<?php echo $row["id_product"];?>')" class="btn btn-info btn-outline btn-circle btn-lg m-r-5" ><i class="ti-pencil-alt"></i></button>
															<button type="button" title="Agregar Proceso" onClick="confirmAddProcess('process.php?id=<?php echo $row["id_product"];?>')" class="btn btn-info btn-outline btn-circle btn-lg m-r-5"><i class="ti-plus"></i></button>
                                                            <button type="button" title="Eliminar" onClick="confirmDelete('delete_product.php?id=<?php echo $row["id_product"];?>')" class="btn btn-info btn-outline btn-circle btn-lg m-r-5"><i class="icon-trash"></i></button>
															<?php
															echo '</td>';
                                                            echo '</tr>';
                                                    } 
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Crear Productos</h3>
                            <p class="text-muted m-b-30"> Verifique que la informacion sea la correcta.</p>
                            <form data-toggle="validator" action="insert_product.go" method="POST">
                                <div class="form-group">
									<div class="row">
										<div class="form-group col-sm-6">
										<label for="product_code" class="control-label">Codigo</label>
											<input type="text" class="form-control" id="product_code" name="product_code" placeholder="Ingrese el codigo del producto" required><div class="help-block with-errors"></div>
										</div>									
										<div class="form-group col-sm-6">
										<label for="product_code" class="control-label">Nombre</label>
											<input type="text" class="form-control" id="name_product" name="name_product" placeholder="Ingrese el nombre del producto" required><div class="help-block with-errors"></div>
										</div>
                                    </div>
                                </div>
                                <div class="form-group">
